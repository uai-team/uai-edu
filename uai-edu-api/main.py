...
def crud_generate():
    """
    新的CRUD
    python main.py crud-generate
    """
    from apps.education.course.models import UaiEduCourseChapterLesson

    crud = CrudGenerate(UaiEduCourseChapterLesson, "课时信息", "lesson")
    # 只打印代码，不执行创建写入
    crud.generate_codes()
    # 创建并写入代码
    crud.main()
