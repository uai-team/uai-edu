...
<template>
  <el-pagination v-show="props.total > 0" v-model:current-page="currentPage" v-model:page-size="pageSize"
    :total="props.total" :background="true" :page-sizes="[20, 50, 100, 200]"
