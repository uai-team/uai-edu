...
import SimulationList from '@/components/Simulation/List.vue'
...
const getCategoryList = async () => {
  const res = await categoryApi.categoryList({ category_type: "simulation" })
  categoryRes = res
  selectCategory = []
}
...
const { page, handlePage, query, handleQuery } = useTable(
  { page: simulationApi.simulationList },
